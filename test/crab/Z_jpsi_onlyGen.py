...
def main():
    ...
    if options.crabCmd == 'submit':
        ...
        config.General.workArea = 'Zjpsi_onlygen'
	config.General.transferOutputs = True
	config.General.transferLogs = False

        config.JobType.pluginName = 'Analysis'
	config.JobType.psetName = '/afs/cern.ch/work/g/gayalasa/public/Zll/z_sl7/ZtoJpsill/CMSSW_10_6_3/src/AnalizeZll/ZtoJpsileplep/test/runOnlyGenZjpsi.py' #2018 MC Z--> 2mu2mu
	...
	config.Site.storageSite = 'T3_US_FNALLPC'
        ...
        inputDatasets = [ 
                          ...
                          #'/ZZTo4L_13TeV_powheg_pythia8/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM' #2016 stefanos
                           '/ZToJPsiMuMu_TuneCUEP8M1_13TeV-pythia8/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM'
                 	]
