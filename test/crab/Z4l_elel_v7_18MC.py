...
def main():
    ...
    if options.crabCmd == 'submit':
        ...
        config.General.workArea = '2018MC_4l_ee_v7_1'
	config.General.transferOutputs = True
	config.General.transferLogs = False

        config.JobType.pluginName = 'Analysis'
	config.JobType.psetName = '/afs/cern.ch/work/g/gayalasa/public/Zll/z_sl7/ZtoJpsill/CMSSW_10_6_3/src/AnalizeZll/ZtoJpsileplep/test/runV7Elec18_4l.py' #2018 DT configfile
   ...
   #     config.Data.totalUnits = 30
	...
	config.Data.outLFNDirBase = '/store/user/%s/Z4l_ee18mc_v7_1/' % ("gayalasa")
