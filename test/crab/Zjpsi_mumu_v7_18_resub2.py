...
def main():
    ...
    if options.crabCmd == 'submit':
        ...
        config.General.workArea = '2018DT_psi_mm_v7_mising'
   ...
   #     config.Data.totalUnits = 30
	config.Data.lumiMask = '/afs/cern.ch/work/g/gayalasa/public/Zll/z_sl7/ZtoJpsill/CMSSW_10_6_3/src/AnalizeZll/ZtoJpsileplep/test/crab/2018DT_psi_mm_v7/crab_EGammaRun2018A-17Sep2018-v2/results/notFinishedLumis.json' #has nosence in Mc
	config.Data.publication = True
        config.Data.outputDatasetTag = None
	config.Data.outLFNDirBase = '/store/user/%s/Zpsi_mm18_v7_resub/' % ("gayalasa")
