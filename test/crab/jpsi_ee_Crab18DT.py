...
def main():
    ...
    if options.crabCmd == 'submit':
        ...
        config.General.workArea = '2018DT_psi_ee_v6'
	config.General.transferOutputs = True
	config.General.transferLogs = False

        config.JobType.pluginName = 'Analysis'
	config.JobType.psetName = '/afs/cern.ch/work/g/gayalasa/public/Zll/z_sl7/jpsielec18mc/CMSSW_10_2_10/src/AnalizeZee/ZelecTupler/test/runDtElec18.py' #2016 MC configfile
   ...
   #     config.Data.totalUnits = 30
	...
	config.Data.outLFNDirBase = '/store/user/%s/Zpsi_ee18DT/' % ("gayalasa")
