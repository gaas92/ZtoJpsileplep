...
def main():
    ...
    if options.crabCmd == 'submit':
        ...
        config.General.workArea = '2017MC_4l_ee_v7_1'
	config.General.transferOutputs = True
	config.General.transferLogs = False

        config.JobType.pluginName = 'Analysis'
	config.JobType.psetName = '/afs/cern.ch/work/g/gayalasa/public/Zll/z_sl7/ZtoJpsill/CMSSW_10_6_3/src/AnalizeZll/ZtoJpsileplep/test/runV7Elec17_4l.py' #2018 DT configfile
   ...
   #config.Data.lumiMask = 'https://cms-service-dqm.web.cern.ch/cms-service-dqm/CAF/certification/Collisions17/13TeV/Final/Cert_294927-306462_13TeV_PromptReco_Collisions17_JSON.txt'
	...
	config.Data.outLFNDirBase = '/store/user/%s/Z4l_ee17mc_v7_1/' % ("gayalasa")
